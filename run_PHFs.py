...
inputs = p21c.InputParameters.from_template("EOS25.toml", random_seed=1234,  node_redshifts=p21c.get_logspaced_redshifts(min_redshift=5.0,z_step_factor=1.02, max_redshift=35.0))
